...
public class ResultActivity extends AppCompatActivity {
    ...
    public void saveData(int myHand, int comHand, int gameResult) {
        ...
        int winningStreakCount = pref.getInt("WINNIN_GSTREAK_COUNT", 0);
        int lastComHand = pref.getInt("LASR_COM_HAND", 0);
        ...
        editor.putInt("BEFORELAST_COM_HAND", lastComHand);
    ...
    private int getHand() {
        ...
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(this);
        int gameCount = pref.getInt("GMAE_COUNT", 0);
